 ...
 * * * Commit #d7fd8d9: testing and syntax debugs, preparation for release, fully added commands and fixed bugs for missing "whitelist" and "numrank"
 * * Version 2: Bug fixes; Alias update!
 * * * Commit #fef0622: Added bug list, changed CommandEcho in clients to be in grey color
 * * * Commit #???????: Added sendChat() to player when permission is changed
 * * * Commit #1ec180a: Added comments for functions and finished initialization regrouping, fixed typo (permission)
 * * * Commit #023dfee: Fixed alias bug; Added two more API functions; Added alias for the events
 * * * Commit #9b79925: Added default plugins! (And therefore now 604 lines) Preparation for release!
 * * Version 3: Important bug fix!
 * * * Commit #???????: Important bug fix!
 * * Version 4: Compatibility update!
 * * * Commit #???????: Updated ompatibility for event "player.chat"
*/
/*
 * Known bugs:
